...
func (f *flag) Init(cmd *cobra.Command) {
	cmd.Flags().StringVar(&f.Filename, flagFilename, "ladysweat.svg", `Name of the output file.`)
	...
	cmd.Flags().StringVar(&f.Color1, flagColor1, "#ffffff", `First color.`)
	cmd.Flags().StringVar(&f.Color2, flagColor2, "#130f40", `Second color.`)
	cmd.Flags().StringVar(&f.Color3, flagColor3, "#22a6b3", `Third color.`)
