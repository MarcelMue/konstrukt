...
func (f *flag) Init(cmd *cobra.Command) {
	cmd.Flags().StringVar(&f.Filename, flagFilename, "riviera.svg", `Name of the output file.`)
	...
	cmd.Flags().StringVar(&f.Color1, flagColor1, "#34495e", `First color.`)
	cmd.Flags().StringVar(&f.Color2, flagColor2, "#e55039", `Second color.`)
