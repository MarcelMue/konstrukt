...
func (f *flag) Init(cmd *cobra.Command) {
	cmd.Flags().StringVar(&f.Filename, flagFilename, "nolock.svg", `Name of the output file.`)
	...
	cmd.Flags().StringVar(&f.Color2, flagColor2, "#34495e", `Second color.`)
	cmd.Flags().StringVar(&f.Color3, flagColor3, "#e74c3c", `Third color.`)
