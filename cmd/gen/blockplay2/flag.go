...
func (f *flag) Init(cmd *cobra.Command) {
	cmd.Flags().StringVar(&f.Filename, flagFilename, "blockplay2.svg", `Name of the output file.`)
	...
	cmd.Flags().StringVar(&f.Color2, flagColor2, "#eb2f06", `Second color.`)
	cmd.Flags().StringVar(&f.Color3, flagColor3, "#f1c40f", `Third color.`)
