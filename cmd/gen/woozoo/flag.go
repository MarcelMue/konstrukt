...
func (f *flag) Init(cmd *cobra.Command) {
	cmd.Flags().StringVar(&f.Filename, flagFilename, "woozoo.svg", `Name of the output file.`)
	...
	cmd.Flags().StringVar(&f.Color1, flagColor1, "#3c6382", `First color.`)
	cmd.Flags().StringVar(&f.Color2, flagColor2, "#b71540", `Second color.`)
	cmd.Flags().StringVar(&f.Color3, flagColor3, "#2c3e50", `Third color.`)
