...
func (f *flag) Init(cmd *cobra.Command) {
	cmd.Flags().StringVar(&f.Filename, flagFilename, "interruptions.svg", `Name of the output file.`)
	...
	cmd.Flags().StringVar(&f.Color1, flagColor1, "#e55039", `First color.`)
	cmd.Flags().StringVar(&f.Color2, flagColor2, "#0a3d62", `Second color.`)
	cmd.Flags().StringVar(&f.Color3, flagColor3, "#55efc4", `Third color.`)
