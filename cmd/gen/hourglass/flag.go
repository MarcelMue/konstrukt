...
func (f *flag) Init(cmd *cobra.Command) {
	cmd.Flags().StringVar(&f.Filename, flagFilename, "hourglass.svg", `Name of the output file.`)
	...
	cmd.Flags().StringVar(&f.Color1, flagColor1, "#0a3d62", `First color.`)
	cmd.Flags().StringVar(&f.Color2, flagColor2, "#78e08f", `Second color.`)
	cmd.Flags().StringVar(&f.Color3, flagColor3, "#079992", `Third color.`)
