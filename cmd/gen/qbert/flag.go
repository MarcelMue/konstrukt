...
func (f *flag) Init(cmd *cobra.Command) {
	cmd.Flags().StringVar(&f.Filename, flagFilename, "qbert.svg", `Name of the output file.`)
	...
	cmd.Flags().StringVar(&f.Color1, flagColor1, "#5040ef", `First color.`)
	cmd.Flags().StringVar(&f.Color2, flagColor2, "#304040", `Second color.`)
	cmd.Flags().StringVar(&f.Color3, flagColor3, "#50af9f", `Third color.`)
