...
func (f *flag) Init(cmd *cobra.Command) {
	cmd.Flags().StringVar(&f.Filename, flagFilename, "blockplay.svg", `Name of the output file.`)
	...
	cmd.Flags().StringVar(&f.Color1, flagColor1, "#ecf0f1", `First color.`)
	cmd.Flags().StringVar(&f.Color2, flagColor2, "#4a69bd", `Second color.`)
