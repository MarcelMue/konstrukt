...
func (f *flag) Init(cmd *cobra.Command) {
	cmd.Flags().StringVar(&f.Filename, flagFilename, "hex22.svg", `Name of the output file.`)
	...
	cmd.Flags().StringVar(&f.Color1, flagColor1, "#fad390", `First color.`)
	cmd.Flags().StringVar(&f.Color2, flagColor2, "#0a3d62", `Second color.`)
	cmd.Flags().StringVar(&f.Color3, flagColor3, "#3498db", `Third color.`)
	cmd.Flags().StringVar(&f.Color4, flagColor4, "#3c6382", `Fourth color.`)
